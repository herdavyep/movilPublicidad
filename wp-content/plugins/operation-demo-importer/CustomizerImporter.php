...
class CEI_Core {
	...
	static public function customizer_import( $import_file_path ) 
	{
		...
		if ( ! file_exists( $import_file_path) ) {
			$cei_error = __( 'Error importing settings! Please try again.', 'wpop-demo-importer' );
			return;
		}
		...
		if ( 'array' != gettype( $data ) ) {
			$cei_error = __( 'Error importing settings! Please check that you uploaded a customizer export file.', 'wpop-demo-importer' );
			return;
		}
		...
		if ( $data['template'] != $template ) {
			$cei_error = __( 'Error importing settings! The settings you uploaded are not for the current theme.', 'wpop-demo-importer' );
			return;
		}
